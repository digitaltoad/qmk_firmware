...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_60_ansi(
         ...
         MO(2),          KC_LALT, KC_LGUI, KC_SPC,  KC_RALT, MO(1),   KC_APP,  KC_RCTL),
  ...
  [1] = LAYOUT_60_ansi(
         ...
         KC_TRNS,        KC_TRNS, KC_TRNS, KC_PGDN, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_MPRV, KC_MNXT, KC_TRNS, \
         KC_TRNS,        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_VOLD, KC_VOLU, KC_MUTE, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, \
  ...
  [2] = LAYOUT_60_ansi(
         ...
         KC_NO,          KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_P4,   KC_P5,   KC_P6,   KC_PCMM, KC_NO,   KC_ENT, \
         KC_NO,          KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_P1,   KC_P2,   KC_P3,   KC_PEQL, KC_NO, \
         KC_NO,          KC_NO,   KC_NO,   KC_P0,   KC_PDOT, KC_PENT, KC_NO,   KC_NO)
